...
app.use(express.urlencoded({extended:true}))  // urlencoded is used to tell the server to handle char and special char which comes from URL and extended is used for nesting of more object data in the json req data
